...
public class OpenGLRenderer implements Renderer {
    ...
    private void prepareData() {
        ...
        texture = TextureUtils.loadTextureCube(context, new int[]{R.drawable.block_andreya, R.drawable.block_andreya,
                R.drawable.block_andreya, R.drawable.block_andreya,
                R.drawable.block_andreya, R.drawable.block_andreya});
    }
    ...
    private void setModelMatrix() {
        ...
        Matrix.rotateM(mModelMatrix, 0, angle, 1, 1, 1);
        bindMatrix();
    }
